...
class Router
{
     ...
     * @param {DEDA.Core.ProxyServer.Router.Config} config - The route configuration.
     */
     ...
     * @returns {DEDA.Core.ProxyServer.Router.Config} Returns the all the component options set to the default values.
     */
...
// Export the class
Router.namespace = "DEDA.Core.ProxyServer.Router";
